  ...
  <div class="row" style="margin-top: 40px;">
    <form class="form-row" method="POST">
      @csrf
        ...
        <div class="col-md-4">
        <input id="datepicker1" name="startDay"  placeholder="Ngày bắt đầu" autocomplete="off"/>
        </div>
        <div class="col-md-4">
        <input id="datepicker2"  name="endDay"  placeholder="Ngày kết thúc"  autocomplete="off"/>
        </div>
        <div class="col-md-2">
