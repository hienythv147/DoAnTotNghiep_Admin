...
class ProductsRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'product_price' => 'bail | required | digits_between:4,6 | regex:/^[0-9]+\d*$/',
            ...
            'product_image' => 'bail | required | max:2048',
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'product_price.digits_between' => 'Giá tiền từ 1k -> 999k!',
            'product_price.regex' => 'Số tiền không hợp lệ!',
