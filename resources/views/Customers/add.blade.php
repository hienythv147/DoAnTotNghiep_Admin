    ...
    <div style="margin-top: 50px;" class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="form-horizontal" action="{{ route('customers-add-process') }}" method="POST" >
                 @csrf
                    ...
                    <div class="input-group">
                        ...
                        type="text" placeholder="Nhập họ" value="{{ old('last_name') }}">
                    </div>
                    {{-- Thông báo lỗi --}}
                    ...
                    type="text" placeholder="Nhập tên" value="{{ old('first_name') }}">
                    </div>
                    {{-- Thông báo lỗi --}}
                    ...
                    <div class="input-group "style="margin-top: 25px">
                        ...
                        type="text" placeholder="Nhập số điện thoại" value="{{ old('phone_number') }}">
                    </div>
                    {{-- Thông báo lỗi --}}
